...
- [src/finclang.langium](src/finclang.langium) -  The grammar definition of your language
- [src/finclang-module.ts](src/finclang-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/finclang-validator.ts](src/finclang-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/finclang.monarch.ts](src/syntaxes/finclang.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/finclang.tmLanguage.json](syntaxes/finclang.tmLanguage.json) - Textmate based syntax highlighting instructions.
